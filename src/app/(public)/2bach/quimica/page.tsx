  ...
  return (
    <div>
      ...
      <nav className="flex items-center gap-2 text-sm text-slate-400 mb-8">
        ...
        <span>/</span>
        <Link href="/2bach" className="hover:text-slate-700 transition-colors">2º Bachillerato</Link>
        <span>/</span>
      ...
      <div className="mb-8">
        ...
        <p className="text-slate-500 ml-12">2º Bachillerato · Temario completo</p>
      ...
      {subjects && subjects.length > 0 ? (
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6">
          {subjects.map((subject: Subject, i: number) => {
            ...
            return (
              ...
              >
                <div className="relative w-full shrink-0 overflow-hidden bg-slate-100" style={{ height: "clamp(160px, 25vw, 240px)" }}>
                  {imgSrc ? (
                ...
                <div className="p-4 sm:p-6 flex flex-col gap-1 sm:gap-2">
                  <h2 className="text-base sm:text-lg font-bold text-[#0f1f3d] leading-snug group-hover:text-blue-600 transition-colors" style={{ fontFamily: "Georgia,serif" }}>
                    {subject.title}
                  </h2>
                  {subject.description && (
        ...
        <div className="text-center py-16 rounded-2xl border border-dashed border-blue-200 text-slate-400">
